...
# ============================================================
# 2. 修复 apk video 仓库（避免 distfeeds 中的 video 条目报错）
# ============================================================
log "修复 apk video 仓库"
...
# ── 4a. passwall 系列涉及的代理核心，彻底删除官方版本 ──
log "清理 feeds 自带的代理核心（feeds/packages/net）"
PASSWALL_PKGS=(
  chinadns-ng
  dns2socks
  geoview
...
# ── 4b. feeds 自带的 LuCI 插件，由后续 git clone 新版替代 ──
log "清理 feeds 自带的冲突 LuCI 插件及应用"
rm -rf \
